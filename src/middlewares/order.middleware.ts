...
async function userIdValid(req: Request, res: Response, next: NextFunction) {
...
async function productIdsValid(req: Request, res: Response, next: NextFunction) {
...
export default { userIdValid, productIdsValid };